        ...
        <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="mb-16">
                <h2 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
                    Connect.<br />
                    <span className="text-purple-600">Communicate.</span><br/>
                    Collaborate.
                </h2>
                <p className="text-xl text-purple-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                    Experience seamless conversations with our modern chat platform. Built for teams, designed for everyone.
                </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
                <div className="glass-effect rounded-2xl p-8 slide-up">
                    ...
                    <p className="text-gray-600">Real-time messaging with instant delivery and synchronization across all devices.</p>
                </div>
                ...
                {/* <div className="glass-effect rounded-2xl p-8 slide-up" style="animation-delay: 0.1s;"> */}
                   <div className="glass-effect rounded-2xl p-8 slide-up">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800 mb-4">Secure & Private</h3>
                ...
                <div className="glass-effect rounded-2xl p-8 slide-up">
                    ...
                    <p className="text-gray-600">Create channels, share files, and collaborate seamlessly with your team.</p>
                </div>
            </div>

            <div className="glass-effect rounded-3xl p-12">
                <h3 className="text-3xl font-bold text-gray-800 mb-4">Ready to transform your communication?</h3>
                <p className="text-gray-600 text-lg mb-8">Join thousands of teams already using ChatFlow to stay connected.</p>
                {/* <button onclick="openModal('signupModal')" className="bg-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-purple-700 transition-all transform hover:scale-105 shadow-xl"> */}
                      <button className="bg-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-purple-700 transition-all transform hover:scale-105 shadow-xl">
                    Start Chatting Now
                </button>
            </div>
        </div>
