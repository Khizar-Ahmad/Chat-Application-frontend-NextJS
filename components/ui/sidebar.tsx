           ...
           <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                        <button className="p-2 hover:bg-gray-200 rounded-full transition-colors">
                            <i data-lucide="message-square-plus" className="w-5 h-5 text-gray-600"></i>
                        </button>
                        <button className="p-2 hover:bg-gray-200 rounded-full transition-colors">
                            <i data-lucide="more-vertical" className="w-5 h-5 text-gray-600"></i>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div className="px-4 py-3 bg-gray-50 border-b border-gray-200">
                <div className="relative">
                    ...
                    <input type="text" placeholder="Search conversations..." className="w-full pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide">
                ...
                <div className="contact-item bg-blue-50 border-l-4 border-blue-500 px-4 py-3 hover:bg-blue-100 cursor-pointer transition-colors" >
                    <div className="flex items-center space-x-3">
                        <div className="relative">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                                <h3 className="font-semibold text-gray-900 truncate">Alice Smith</h3>
                                <span className="text-xs text-gray-500">2:30 PM</span>
                            </div>
                            <p className="text-sm text-gray-600 truncate">That sounds great! Let's do it 🚀</p>
                        </div>
