    ...
    export default function LoginModal (){
      ...
      const triggerLoginHandler = async(data: SignupFormData) =>{
        ...
        return(
              <div id="loginModal" className="fixed inset-0 modal-backdrop flex items-center justify-center z-50">
        <div className="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl slide-up">
            ...
            <form className="space-y-6" onSubmit={handleSubmit(triggerLoginHandler)}>
                <div>
                ...
                <div>
                    ...
                    <input type="password" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all" {...register('password')} placeholder="Enter your password"/>
            ...
            <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                    ...
                    <button className="text-purple-600 hover:text-purple-800 transition-colors font-medium">Sign up</button>
                </p>
            </div>
        </div>
    </div> 
